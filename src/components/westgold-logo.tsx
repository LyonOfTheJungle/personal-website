...
export const WestgoldLogo: FC<LogoProps> = (props) =>  (
    <SvgIcon>
        <svg width="212" height="184" viewBox="0 0 212 184" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19.5 52L0 42L19 141L41 153L65.5 139L74 174L94.5 184L115 172.5L137 184L115 104.5L96 94.5L116.5 82.5L137.5 93.5L148 140L164.5 77.5L116.5 54.5L67 77.5L48 66.5L94.5 44.5L44.5 20.5L38 43L19.5 52Z" fill={props.color1}/>
